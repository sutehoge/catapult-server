...
#define TEST_CLASS FinalizationProofVerifierTests
	...
	namespace {
		...
		auto CreateFinalizationStatistics(Height heightDelta, const Hash256& hash) {
			return model::FinalizationStatistics{ { Finalization_Epoch, Finalization_Point }, Last_Finalized_Height + heightDelta, hash };
		}
	...
	TEST(TEST_CLASS, VerifyFailsWhenProofPointDoesNotMatchContextEpoch) {
